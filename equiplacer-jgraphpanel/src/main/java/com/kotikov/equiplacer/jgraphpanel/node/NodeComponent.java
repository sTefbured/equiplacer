package com.kotikov.equiplacer.jgraphpanel.node;

import javax.swing.*;
import java.awt.*;
import java.awt.geom.Ellipse2D;

public class NodeComponent<T extends Number> extends JComponent {
    ...
    public NodeComponent(T value, int diameter, Color backgroundColor) {
        super();
        this.value = value;
    ...
    public NodeComponent(T value, int diameter) {
